...
public class SearchAPI extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	// 네이버 검색 API 예제 - 블로그 검색
    			//1. 인증 정보 설정
    			String clientId = "FSOzxXO7BcNyseqYSTkb"; //애플리케이션 클라이언트 아이디
    			String clientSecret = "8JYaetg7Zz"; //애플리케이션 클라이언트 시크릿
    			...
    			String apiURL = "https://openapi.naver.com/v1/search/webkr?query=" + text + "&display=10&start=" + startNum;    // JSON websearch 결과
