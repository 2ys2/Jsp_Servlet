	...
	public static Connection getConnection(String dsn) {
		...
		try {
			if( dsn.equals("mysql") ) {
			    ...
			    conn = DriverManager.getConnection("org.gjt.mm.mysql.Driver","user01", "mysql"); 
			    
			} else if( dsn.equals("oracle") ) {
				Class.forName("oracle.jdbc.OracleDriver");
			    conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl","user01", "oracle"); 
